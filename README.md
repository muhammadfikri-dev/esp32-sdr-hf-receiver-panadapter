# ⚡ ESP32 Software Defined Radio (SDR) HF Receiver & Web Panadapter
...
Direct sampling SDR processing quadrature I/Q mixer inputs via DMA ADC, performing Hilbert transform, demodulating AM/SSB, and streaming waterfall spectrum over Wi-Fi.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-sdr-hf-receiver-panadapter.ino`](./esp32-sdr-hf-receiver-panadapter.ino).
