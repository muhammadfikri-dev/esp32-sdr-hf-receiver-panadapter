/**
 * =========================================================================================
 * Project     : ESP32 Software Defined Radio (SDR) HF Receiver & Web Panadapter
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Direct sampling SDR processing quadrature I/Q mixer inputs via DMA ADC, performing Hilbert transform, demodulating AM/SSB, and streaming waterfall spectrum over Wi-Fi.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-sdr-hf-receiver-panadapter";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Software Defined Radio (SDR) HF Receiver & Web Panadapter"));
